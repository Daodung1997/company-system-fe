import{B as t,s as m,bN as l,bx as c,o as s,c as p,W as i,a as g,m as d}from"./DRirR6ft.js";var h=`
    .p-imagecompare {
        position: relative;
        overflow: hidden;
        width: 100%;
...
`,u={root:"p-imagecompare",slider:"p-imagecompare-slider"},b=t.extend({name:"imagecompare",style:h,classes:u}),v={name:"BaseImageCompare",extends:m,props:{tabindex:{type:Number,default:0},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:b,provide:function(){return{$pcImageCompare:this,$parentInstance:this}}},f={name:"ImageCompare",extends:v,methods:{onSlide:function(a){var n=a.target.value,o=a.target.previousElementSibling;l(o,c("imagecompare.scope.x").name,"".concat(n,"%"))}}},w=["aria-labelledby","aria-label"];function y(e,a,n,o,z,r){return s(),p("div",d({class:e.cx("root"),"aria-labelledby":e.ariaLabelledby,"aria-label":e.ariaLabel},e.ptmi("root")),[i(e.$slots,"left"),i(e.$slots,"right"),g("input",d({type:"range",min:"0",max:"100",value:"50",onInput:a[0]||(a[0]=function(){return r.onSlide&&r.onSlide.apply(r,arguments)}),class:e.cx("slider")},e.ptm("slider")),null,16)],16,w)}f.render=y;export{f as default};
